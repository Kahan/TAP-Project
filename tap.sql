...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2020 at 02:13 PM
...
(1, 'qwed', '@.com', '1234567890', 'pune', 'coding', 'asdfg', NULL, NULL, 'C'),
(2, 'ppoiuyt', '12@.com', '0987654321', 'mumbai', 'dance', 'qwerty', NULL, NULL, 'B'),
(3, 'qwed', '123@.com', '1234567890', 'pune', 'dance', 'asdfg', NULL, NULL, 'C'),
(4, 'bapoiuyt', '1234@.com', '0987654321', 'mumbai', 'coding', 'qwerty', NULL, NULL, 'B'),
(5, 'cbapoiuyt', '12345@.com', '0987654321', 'm', 'p', 'zxcvb', NULL, NULL, 'A'),
...
(11, 'dcbapoiuyt', '123456@.com', '0987654321', 'mumbai', 'coding', 'zxcvb', NULL, NULL, 'A'),
...
(20, 'meet', 'raj@gmail.com', '9768135201', '', 'visual arts', 'NMMPS', 'd\\rfzsdtg', 'seryry', ''),
(27, 'ujas', 'ujasitalia216@gmail.com', '9768135201', 'mumbai', 'public speaking', 'MJPMPS', 'coding', 'personal interest', '');
...
--
ALTER TABLE `applicants`
  MODIFY `Sr` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
COMMIT;
